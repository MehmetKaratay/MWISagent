...
class TestQueryUrlCLI(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with open(self.csv_path, "w", encoding="utf-8") as f:
            ...
            f.write(
                "EH,Eastern Highlands,900m,FL,Scotland,https://mwis.org.uk/forecasts/scottish/cairngorms/text\n"
            )
    ...
    def test_default_json_output(self):
        ...
        self.assertEqual(
            data, {"url": "https://mwis.org.uk/forecasts/scottish/west-highlands/text"}
        )
    ...
    def test_case_insensitive_name(self):
        ...
        self.assertEqual(
            data,
            {
                "url": "https://mwis.org.uk/forecasts/scottish/the-northwest-highlands/text"
            },
        )
    ...
    def test_programmatic_resolve_url(self):
        ...
        self.assertEqual(
            resolve_url("WH", self.csv_path),
            "https://mwis.org.uk/forecasts/scottish/west-highlands/text",
        )
        self.assertEqual(
            resolve_url("eastern highlands", self.csv_path),
            "https://mwis.org.uk/forecasts/scottish/cairngorms/text",
        )
